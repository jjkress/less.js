...
less.Parser = function Parser(env) {
    ...
    function LessError(e, env) {
        console.log("=== JJ LOG :226 ===");
        console.log("Logging e");
        console.log(e);
        console.log("=== JJ LOG :229 ===");
    ...
    return parser = {
        ...
        parse: function (str, callback) {
            ...
            root.toCSS = (function (evaluate) {
                ...
                return function (options, variables) {
                    ...
                    if ((importError = parser.imports.error)) { // Check if there was an error during importing
                        console.log("=== JJ LOG :401 ===");
                        console.log("Logging importError");
                        console.log(importError);
                        console.log("=== JJ LOG :404 ===");
                        console.log("Logging env");
                        console.log(env);
            ...
            if (i < input.length - 1) {
                ...
                console.log("=== JJ LOG :450 ===");
                console.log("Logging newly created error");
                console.log(error);
                console.log("=== JJ LOG :453 ===");
                console.log("Logging env");
                console.log(env);
