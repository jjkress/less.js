...
var less = {
    ...
    render: function (input, options, callback) {
        console.log("Calling render() in index.js:10 with (input, options, callback)");
        console.log("== input ==");
        console.log(input);
        console.log("== options ==");
        console.log(options);
        ...
        if (callback) {
            console.log("About to call parser.parse() in index.js:22 with:")
            console.log(input);
            ...
            process.nextTick(function () {
                console.log("About to call parser.parse() at index.js:31 with:")
                console.log(input);
                parser.parse(input, function (e, root) {
...
less.Parser.importer = function (file, paths, callback, env) {
    console.log("Calling importer in index.js:103");
